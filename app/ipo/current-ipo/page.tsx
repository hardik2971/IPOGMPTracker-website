...
export default function CurrentIPOPage() {
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm mb-4">
                      ...
                      <div className="grid grid-cols-3 text-sm font-semibold text-[#4C3FB6] p-2 gap-2">
                        ...
                        <Link href="/ipo/listed-ipo">
                          <button
                            className={`w-full px-6 py-3 text-center rounded-md border transition-colors ${isListed
                                ? "bg-[#F4F3FF] border-[#6B46C1] text-[#1A237E]"
                                : "border-[#C5B8FF] hover:bg-[#F8F7FF] text-[#4C3FB6]"
                              }`}
                          >
                        ...
                        <RadioGroup
                          ...
                          onValueChange={(value) => {
                            ...
                            if (value === "All") {
                              ...
                              router.push("/sme-ipo/current-ipo");
                            }
                          }}
