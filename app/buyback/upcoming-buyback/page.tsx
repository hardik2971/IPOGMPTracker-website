...
export default function UpcomingBuyback() {
  const pathname = usePathname();
  const isCurrent = pathname === "/buyback/current-buyback";
  const isUpcoming = pathname === "/buyback/upcoming-buyback";
  const isClosed = pathname === "/buyback/closed-buyback";  
  const upcomingIPOs = [
    {
      ...
      <section className="py-10 px-4 bg-[#f2f4ff]">
        <div className="container mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-600 mb-4">
            ...
            <ChevronRight className="w-4 h-4 text-gray-400" />
            <span className="font-medium text-gray-900">Upcoming Buyback</span>
          </nav>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm mb-4">
                      ...
                      <div className="grid grid-cols-3 text-sm font-semibold text-[#4C3FB6] p-2 gap-2">
                        <Link href="/buyback/current-buyback">
                          <button
                            className={`w-full px-6 py-3 text-center rounded-md border transition-colors ${isCurrent
                        ...
                        <Link href="/buyback/upcoming-buyback">
                          <button
                            className={`w-full px-6 py-3 text-center rounded-md border transition-colors ${isUpcoming
                              ? "bg-[#F4F3FF] border-[#6B46C1] text-[#1A237E]"
                              : "border-[#C5B8FF] hover:bg-[#F8F7FF] text-[#4C3FB6]"
                              }`}
                          >
                        ...
                        <Link href="/buyback/closed-buyback">
                          <button
                            className={`w-full px-6 py-3 text-center rounded-md border transition-colors ${isClosed
                              ? "bg-[#F4F3FF] border-[#6B46C1] text-[#1A237E]"
                              : "border-[#C5B8FF] hover:bg-[#F8F7FF] text-[#4C3FB6]"
                              }`}
                          >
