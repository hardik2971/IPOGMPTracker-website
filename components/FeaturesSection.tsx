  ...
  const features = [
    {
      ...
      description:
        "Track all ongoing IPOs, upcoming IPOs, and recently Listed IPOs in one place. Never miss upcoming IPOs like Sunshine Pictures, Hero Motors, Veritas Finance, SK Finance, Prestige Hospitality Ventures, Skyways Air Services, Milky Mist Dairy Food, Shadowfax Technologies, CMR Green Technologies, IndiaFirst Life Insurance Company, and more.",
    ...
    },
    {
      ...
      description:
        "Cut the clutter! Use IPOGMPTracker's integrated platform to apply for IPOs online easily. Know the expected premium, and plan your investment for maximum listing day gains.",
      highlightedTerms: [],
    },
    {
      icon: Bell,
      title: "Stay Updated",
      description:
        "Stay updated with all upcoming Mainboard IPOs and upcoming SME IPOs in India. IPOGMPTracker provide detailed insights into draft papers, tentative dates, price bands, lot sizes, and subscription status.",
    ...
    },
    {
      ...
      description:
        "Track all Mainboard IPOs listed on NSE and BSE from upcoming IPOs and current IPOs to past listings. Stay updated with performance insights, subscription status, and detailed data on large-cap company offerings.",
    ...
    },
    {
      ...
      title: "SME IPOs",
      description:
        "Get detailed coverage of SME IPOs, including current SME IPOs and upcoming SME IPOs from emerging small and medium enterprises.",
  ...
  return (
    <section className="py-10 sm:py-12 md:py-16 px-4 bg-[#f2f4ff]">
      <div className="container mx-auto">
        ...
        <div className="text-gray-600 text-base sm:text-lg font-medium mb-6 sm:mb-8 text-center max-w-2xl mx-auto px-4">
          Looking for the latest IPOs in India? At IPOGMPTracker, you get
          everything under one roof—from mainboard IPOs to SME IPOs, GMP
          updates, live subscription data, and allotment status.
        </div>
